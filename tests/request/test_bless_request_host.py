...
@pytest.mark.parametrize("test_input", ["this..that", ["thisthat"], "this!that.com"])
...
@pytest.mark.parametrize(
    "test_input", ["this..that", ["thisthat"], "this!that.com", "this,that"]
)
...
@pytest.mark.parametrize(
    "test_input", ["thisthat,this.that,10.1.1.1", "this.that,thishostname"]
)
def test_valid_multiple_hostnames(test_input):
    BlessHostSchema().validate_hostnames(test_input)


@pytest.mark.parametrize("test_input", ["thisthat, this.that",])
