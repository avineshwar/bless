...
def test_basic_local_request_ed2551():
    ...
    assert output["certificate"].startswith(
...
def test_basic_local_username_validation_email_remote_usernames_useradd(
        monkeypatch):
    extra_environment_variables = {
        "bless_ca_default_password":
        "<INSERT_DEFAULT_KMS_ENCRYPTED_BASE64_ENCODED_PEM_PASSWORD_HERE>",
...
def test_basic_ca_private_key_file_bz2(monkeypatch):
    extra_environment_variables = {
        ...
        "<INSERT_DEFAULT_KMS_ENCRYPTED_BASE64_ENCODED_PEM_PASSWORD_HERE>",
        "bless_ca_ca_private_key_file":
        "tests/aws_lambda/only-use-for-unit-tests.pem.bz2",
...
def test_basic_ca_private_key_file_zlib(monkeypatch):
    extra_environment_variables = {
        ...
        "<INSERT_DEFAULT_KMS_ENCRYPTED_BASE64_ENCODED_PEM_PASSWORD_HERE>",
        "bless_ca_ca_private_key_file":
        "tests/aws_lambda/only-use-for-unit-tests.zlib",
